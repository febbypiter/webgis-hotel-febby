var map;
var server = "http://localhost/hosting-master/tourism_bkt/";
...
{
  $('#tombol').empty();
  $('#tombol').append('<a type="button" id="hidelegenda" onclick="hideLegenda()" class="btn btn-success " data-toggle="tooltip" title="Sembunyikan Legenda" style="margin-right: 5px;color:green;"><i class="fa fa-eye-slash style="margin-right: 5px; color:green;"></i></a> ');
...
function hideLegenda() {
  ...
  $('#tombol').empty();
  console.log("Sukses");
  $('#tombol').append('<a type="button" id="showlegenda" onclick="legenda()" class="btn btn-success " data-toggle="tooltip" title="Legenda" style="margin-right: 5px; color:green;"><i class="fa fa-eye" style="color:green;"> </i></a>');
}
  ...
  for (var i in rows.data){ 
    ...
    marker.info = new google.maps.InfoWindow({
       //content: "<span style=color:black><center><b>"+name+"</b></center><br><i class='fa fa-map-marker'></i>"+address+"<br><i class='fa fa-money'></i>"+ticket+"<br><br><a class='btn btn-success fa fa-road' role=button' onclick='route_sekitar(\""+pos_lat+"\",\""+pos_lng+"\",\""+rad_lat+"\",\""+rad_lng+"\")' title='route' aria-controls='Route' id='btn_angkot'></a>&nbsp<a class='btn btn-success fa fa-info' role=button' onclick='galeri(\""+ids+"\")' title='Info' aria-controls='Info' id='btn_gallery'></a></label>&nbsp<a class='btn btn-success fa fa-compass' role=button' onclick='cekNearBy()' title='Nearby' aria-controls='Nearby' id='btn_angkot'></a><a class='btn btn-success fa fa-map-marker' role=button' onclick='setLastPos("+rad_lat+", "+rad_lng+")' title='I am Here' id='btn_here'></a></span>",
        ...
        content: "<span style=color:black><center><b>"+name+"</b></center><br><i class='fa fa-map-marker'></i>"+address+"<br><i class='fa fa-money'></i>"+ticket+"<br><br><a class='btn btn-success fa fa-road'title='route' role=button' onclick='route_sekitar(\""+pos_lat+"\",\""+pos_lng+"\",\""+rad_lat+"\",\""+rad_lng+"\")' title='route' aria-controls='Route' id='btn_angkot'></a>&nbsp<a class='btn btn-success fa fa-info' role=button' onclick='galeri(\""+ids+"\")' title='Info' aria-controls='Info' id='btn_gallery'></a></label>&nbsp<a class='btn btn-success fa fa-compass' title='nearby' role=button' onclick='cekNearBy()' title='Nearby' aria-controls='Nearby' id='btn_angkot'></a>&nbsp<a class='btn btn-success fa fa-map-marker' title='Position' role=button' onclick='setLastPos("+rad_lat+", "+rad_lng+")' title='Position' id='btn_here'></a></span>",
...
// alert(rad_lat);
alert("You are Now on "+rad_lat+", "+rad_lng);
}
  ...
  $.ajax({url: server+'_data_tourism_cari.php?tipe='+tipe+'&nilai='+y, data: "", dataType: 'json', success: function(rows){ 
    if(rows == null)
    {
      ...
      for (var i in rows){ 
        ...
        var lng = row.lng;
        var lat = row.lat;
        $('#kanan_table').append("<tr><td>"+name+"</td><td><a role='button'  class='btn btn-success fa fa-info'title='info' onclick='data_tourism_1_info(\""+id+"\")'></a></td><td><a role='button'  class='btn btn-success fa fa-road' title='route' onclick='route_sekitar(\""+pos_lat+"\",\""+pos_lng+"\",\""+lat+"\",\""+lng+"\")'></a></td></tr>");  
...
{ 
    for (var i in rows){ 
      ...
      $('#table_kanan_angkot').append("<tr><td>"+destination+"</td><td><a role='button' class='btn btn-success fa fa-info' title='info' onclick='modal_angkot(\""+ids+"\")'></a><a style='margin-left:10px' role='button' class='btn btn-success fa fa-road' title='route' onclick='clearangkot(modal_angkot);route_angkot(\""+lat2+"\",\""+lng2+"\",\""+lat+"\",\""+lng+"\",\""+ids+"\",\""+id+"\")'></a></td></tr>");         
    }               
}});      
}
...
{ 
    for (var i in rows){ 
      ...
      console.log(id);
      route_angkot_1(id,color);
      $('#table_kanan_angkot').append("<tr><td>"+destination+"</td><td><a role='button' class='btn btn-success fa fa-info' title='info' onclick='modal_angkot(\""+ids+"\")'></a></td><td><a style='margin-left:10px' role='button' class='btn btn-success fa fa-road' title='route' onclick='clearangkot();route_angkot(\""+lat2+"\",\""+lng2+"\",\""+lat+"\",\""+lng+"\",\""+ids+"\",\""+id+"\")'></a></td></tr>");         
    }               
}});      
}
