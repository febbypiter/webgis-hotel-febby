...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA1TwYksj1uQg1V_5yPUZqwqYYtUIvidrY&callback=basemaps"></script>
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg" style="background-color:black;border-bottom:1px solid black;">
        ...
        <!--logo start-->
        <a href="index.php" class="logo" style="color:white;"><b>WebGis Hotel (12 1811522001 Velia Andrini Fahira)</b></a>
        <div class="top-menu">
                        ...
                        <div class="white-panel pns"  id="galleryrecommendxxx"style="height:510px">
                           ...
                           <div class="container2">
                              ...
                              <div class="mySlides">
                                ...
                                <div class="mySlides">
                                  <a href="" onclick="galleryreco('H030')"><img src="../_foto/H0301.jpg" style="width:100%"><div class="text" style="color:white">Novotel</div></a>
                                </div>
                                 <div class="mySlides">
                                  <a href="" onclick="galleryreco('H006')"><img src="../_foto/H0061.jpg" style="width:100%"><div class="text" style="color:white">Campago Resort Hotel</div></a>
                                </div>
                              ...
                              <div class="row2">
                                ...
                                <div class="column">
                                  <img class="demo cursor" src="../_foto/H0305.jpg" style="width:100%" onclick="currentSlide(3)">
                                </div>
                                <div class="column">
