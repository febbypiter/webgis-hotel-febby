...
<head>
  ...
  <body onload="init();data_hotel_1_info('<?php echo $_GET["idgallery"] ?>');">
   ...
   <section id="container" >
                    ...
                    <div class="col-sm-12"> <!-- gallery -->
                      <section class="panel">
                          <div class="panel-body">
                              ...
                              <div class="html5gallery" style="max-height:700px; overflow:auto;" data-skin="horizontal" data-width="450" data-height="300" data-resizemode="fit">  
    ...
    <script src="_map8.js" type="text/javascript"></script>
