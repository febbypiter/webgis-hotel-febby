  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg" style="background-color:black;border-bottom:1px solid black;">
        ...
        <!--logo start-->
        <a href="index.php" class="logo" style="color:white;"><b>WebGIS Object Hotel (15 1811522007 Febby Putri Milenia Piter )</b></a>
        <div class="top-menu">
                      ...
                      <div class="col-md-12 col-sm-12 mb">
                        <div class="white-panel pns">
                          ...
                          <header class="panel-heading" style="float:left">
                            ...
                            <a class="btn btn-success" role="button" data-toggle="collapse" onclick="posisisekarang()" title="Current Position" style="margin-right:10px"   ><i class="fa fa-location-arrow" style="color:white;"></i></a>
