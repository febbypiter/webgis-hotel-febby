  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
		      <form class="form-login" action="act/login.php" method="post">
		        <h2 class="form-login-heading" style="background-color:black;border-bottom:1px solid black;">sign in now</h2>
                ...
                <button class="btn btn-theme btn-block" type="submit" name="submit" style="background-color:black;border-bottom:1px solid black;"><i class="fa fa-lock"></i> SIGN IN</button>
                <div class="registration">
		            ...
		            <hr>
                <a href="../" class="btn btn-theme btn-block"style="background-color:black;border-bottom:1px solid black;">Back</a>
		        </div>
