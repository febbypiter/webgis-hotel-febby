  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
          <form class="form-login" action="hotel_bkt/index.php" method="post">
            <h2 class="form-login-heading" style="background-color:black;border-bottom:black;color:white">Pariwisata Bukittinggi</h2>
		  ...
		  <option value="9">Jambu Air-Cingkariang</option>
               ...
               <hr>
              <button type="submit" class="btn btn-theme btn-block"style="background:black;border-color:white">Pilih</button>   
            </div>
          </form>     
